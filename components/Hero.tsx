...
const Hero = () => {
    return (
        <section className="relative overflow-hidden pb-18 pt-8 sm:pb-20 sm:pt-10">
            ...
            <div className="pointer-events-none absolute inset-x-0 top-28 h-40 bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.06),transparent)] blur-3xl" />
            <Container>
                <div className="relative">
                    <div className="flex items-center rounded-full border border-border/70 bg-background/55 px-4 py-3 shadow-[0_18px_60px_-42px_rgba(0,0,0,0.95)] backdrop-blur-xl">
                        <Logo />
                    </div>
